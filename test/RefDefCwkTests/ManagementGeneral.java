...
//    rejoin a staff who is on holiday
    ...
    public void rejoinStaffFromHoliday(){
        pr.hireStaff("Eli");
        pr.doJob(102);
        String rejoinOutcome = pr.staffRejoinTeam("Eli");
        String expected = "Eli rejoined the team after holiday";
...
//    rejoin a staff not in team
    ...
    public void rejoinStaffNotInTeam(){
        String rejoinOutcome = pr.staffRejoinTeam("Hui");
        String expected = "Hui not in team so can't return from holiday";
        assertEquals(rejoinOutcome, expected);
    }
...
//    restore a saved prject
    ...
    public void restoreSavedProject(){
        pr.hireStaff("Amir");
        pr.saveITProject("AmirInTeam.proj");
        double balanceAfterAmir = pr.getAccount();
        pr.hireStaff("Bela");
        double balanceAfterBela = pr.getAccount();
        pr = pr.restoreITProject("AmirInTeam.proj");
        double balanceAfterRestoration = pr.getAccount();
        assertTrue((balanceAfterAmir == balanceAfterRestoration) && (balanceAfterBela != balanceAfterRestoration));
    }
    ...
    public void checkSecondConstructorOfProject(){
        ITProject pr2 = new ITProject("Bob", 1000, "./src/RefDefCwk/jobs.txt");
