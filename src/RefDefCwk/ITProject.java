...
public class ITProject implements BITS, Serializable {
    ...
    private List<Staff> staffsInTeam = new ArrayList<>();
...
//**************** BITS ************************** 
    ...
    public String toString() {
        ...
        sb.append("Project Information : ").append("\n");
...
//**********************Jobs************************* 
    ...
    public String hireStaff(String name) {
        ...
        if (!getStaff(name).equals("\nNo such staff")) {
            staff = getStaffData(name);
            if (staff.getStaffState() == StaffState.AVAILABLE) {
                if (account >= staff.getRetainer()) {
                    staff.setStaffState(StaffState.WORKING);
                    account -= staff.getRetainer();
                    staffsInTeam.add(staff);
                    result += " hired";
...
//****************** private methods for Task 6.1 functionality*******************
    ...
    private void setupStaff() {
        staffs.add(new Staff("Amir", 2, 300.0, "false", "false", 30.0, "Designer", StaffState.AVAILABLE));
        staffs.add(new Staff("Bela", 2, 100.0, "false", "false", 30.0, "Engineer", StaffState.AVAILABLE));
        staffs.add(new Staff("Ceri", 4, 250.0, "true", "false", 40.0, "Engineer", StaffState.AVAILABLE));
        staffs.add(new Staff("Dana", 2, 200.0, "false", "true", 20.0, "Programmer", StaffState.AVAILABLE));
        staffs.add(new Staff("Eli", 7, 200.0, "false", "true", 20.0, "Programmer", StaffState.AVAILABLE));
        staffs.add(new Staff("Firat", 6, 300.0, "false", "true", 90.0, "Designer", StaffState.AVAILABLE));
        staffs.add(new Staff("Gani", 2, 200.0, "false", "true", 20.0, "Programmer", StaffState.AVAILABLE));
        staffs.add(new Staff("Hui", 8, 450.0, "true", "false", 40.0, "Engineer", StaffState.AVAILABLE));
        staffs.add(new Staff("Jaga", 4, 300.0, "false", "true", 60.0, "Designer", StaffState.AVAILABLE));
    }
